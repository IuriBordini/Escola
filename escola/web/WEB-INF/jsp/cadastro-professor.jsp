    ...
    <body>
        ...
        <jsp:include page="include/menu.jsp"></jsp:include>
            <div class="container" id="conteudo">
                ...
                <form class="form-horizontal" action="CadastrarProfessor" method="POST">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="salario" name="salario" type="text" placeholder="" class="form-control input-md" required="">
